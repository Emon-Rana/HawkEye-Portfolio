				...
				<div class="top-header">
					...
					<div class="top-nav">
						<div class="navigation">
							<div class="logo">
								<h1><a href="UserHome.php" ><span class="rotate">H</span>awkEye</a></h1>
							</div>
							<div class="navigation-right">
								<span class="menu"><img src="images/menu.png" alt="Image" /></span><!--Hidden menu for responsive mini device-->
								<nav class="link-effect-3" id="link-effect-3" >
									<ul class="nav1 nav nav-wil" >
										<li class="active" ><a data-hover="Home" href="UserHome.php" >Home</a></li>
										...
										<li><a class="scroll" data-hover="Contact" href="#contact" >Contact</a> </li>
											...
											<li style="display:none;"><a name="LogOut" class="scroll" data-hover="LogOut" href="index.php?logout='1'" >LogOut</a> </li>
											<?php endif ?> <!--/This is for logout feature-->
									</ul>
								</nav>
								<!--Script for menu-->
								<script>
						...
						<div class="col-md-7 header-right">
							...
							<ul class="address">
								...
								<li>
									<ul class="address-text">
										<li><b>Phone : </b></li>
										<li>+88 01941456972</li>
									</ul>
								</li>
								<li>
									<ul class="address-text">
										<li><b>address : </b></li>
										<li> Mirpur-13, Dhaka-1216</li>
									</ul>
								</li>
								<li>
									<ul class="address-text">
										<li><b>Email : </b></li>
										<li><a href="mailto:emonrana72@gmail.com">emonrana72@gmail.com</a></li>
									</ul>
								</li>
								<li>
									<ul class="address-text">
				...
				<div id="owl-demo1" class="owl-carousel owl-carousel2">
					...
					<div class="item">
						<div class="about-left-grid">
							...
							<p>
								Lorem Ipsome Dolore Site Amet.Lorem Ipsome Dolore Site Amet.Lorem Ipsome Dolore Site Amet.Lorem Ipsome Dolore Site Amet.Lorem Ipsome Dolore Site Amet.Lorem Ipsome Dolore Site Amet.
							</p>
							<ul>
